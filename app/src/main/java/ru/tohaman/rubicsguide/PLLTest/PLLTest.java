...
public class PLLTest {
    ...
    public PLLTest(String mPhase, int mId, String mTitle, int mIcon, int mDescription, String mUrl, String mComment){
        this.mPhase = mPhase;
        this.mId = mId;
        this.mTitle = mTitle;
        this.mIcon = mIcon;
    ...
    public PLLTest(String mPhase, int mId, String mTitle, int mIcon) {
        this.mPhase = mPhase;
        this.mId = mId;
        this.mTitle = mTitle;
        this.mIcon = mIcon;
    ...
    public PLLTest(int Id, String Phase, String comment) {
        this.mPhase = Phase;
        this.mId = Id;
        this.mTitle = "";
        this.mIcon = 0;
